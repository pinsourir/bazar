...
Travail réalisé en parallèle par le groupe :

- **Béatrice (routeur TL-MR100)** :
  - Première prise en main du routeur TP-Link TL-MR100.
  - Configuration réseau de base et vérification de la connectivité avec le srv Linux.
  - Tests de connectivité réalisés avec succès (ping entre le routeur et la VM).
  - Début des tests de segmentation Wi-Fi.
  - Interruption des tests suite à un crash de la VM lors des premières manipulations de segmentation
    (problème identifié comme lié à l’environnement de virtualisation, tests reportés).

- **Sarah (Wazuh)** :
  - Début de la prise en main de la solution de supervision Wazuh.
  - Tentative d’installation du manager Wazuh sur le srv Linux.
  - Découverte de l’environnement, de l’architecture Wazuh et des composants (manager, agents, dashboards).
  - Les tests de supervision seront approfondis lors des prochaines séances.
